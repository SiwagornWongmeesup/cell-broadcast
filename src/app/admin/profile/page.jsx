    ...
    return (
      <div className="min-h-screen  bg-gray-100 text-white flex">
        ...
        <div className="flex-1 flex justify-center items-center p-4">
          <div className="w-full max-w-2xl bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-10">
            {/* Profile Image */}
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-gray-200">
              โปรไฟล์ของฉัน
            </h1>
