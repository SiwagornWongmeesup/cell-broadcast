...
export default function AdminDashboard() {
  ...
  try {
    const res = await fetch("/api/admin/send-alert", {
      ...
      body: JSON.stringify({
        message: report.details,      // จาก UserReport
        type: report.title,         // จาก UserReport
        radius: 500,                  // ค่า default หรือปรับเอง
        location: report.location,    // ต้องมี lat + lng
        fileUrl: report.file || null, // ถ้ามีไฟล์แนบ        
      }),
    });
